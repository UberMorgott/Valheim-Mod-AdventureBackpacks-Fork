...
(e.g. $adventurebackpacks_rugged_backpack)
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| name | [System.String](http://msdn.microsoft.com/query/dev14.query?appId=Dev14IDEF1&l=EN-US&k=k:System.String 'System.String') | Effect name (e.g. "$some_effect_name"). |
| localizedName | [System.String](http://msdn.microsoft.com/query/dev14.query?appId=Dev14IDEF1&l=EN-US&k=k:System.String 'System.String') | Localized effect name shown in configuration and HUD/GUI (e.g. "Water Resistance"). |
| effectName | [System.String](http://msdn.microsoft.com/query/dev14.query?appId=Dev14IDEF1&l=EN-US&k=k:System.String 'System.String') | Registered effect name (e.g. SetEffect_NecromancyArmor or SE_Demister). |
| description | [System.String](http://msdn.microsoft.com/query/dev14.query?appId=Dev14IDEF1&l=EN-US&k=k:System.String 'System.String') | Status effect description; shows up in configuration. |
| statusEffect | `StatusEffect` | The status effect itself; any SE_Stats works. |
...
### EffectDefinition.Name `constants`
