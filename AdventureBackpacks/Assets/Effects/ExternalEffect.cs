...
public class ExternalEffect : EffectsBase
{
    ...
    public override void RegisterEffectConfiguration()
    {
        ...
        {
            AdventureBackpacks.Log.LogError($"Status Effect is null for {_effectDefinition.Name} - Disabling Status Effect");
    ...
    private void LoadExternalStatusEffect()
    {
        ...
        {
            AdventureBackpacks.Log.LogError($"Can't Load External Status Effect: {_effectName} - Message: {e.Message}");
        }
    }
